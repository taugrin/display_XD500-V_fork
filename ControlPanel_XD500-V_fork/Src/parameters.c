...
static const tParam group93_params[] = {
	{"01 ÂÊË. ÄÈÍ. ÒÎĞÌ.",		0x5D00,		0,     1,  PAR_IS_UINT,    1,		 NULL, true, false, UNITS_VOID},
	{"02 ÍÈÆ. ÏĞÅÄÅË ÍÀÏĞ",		0x5D01,  5000, 10000,  PAR_IS_UINT,   10,		 NULL, true, false, UNITS_VOLT},
	{"03 ÂÅĞÕ. ÏĞÅÄÅË ÍÀÏĞ",	0x5D02,	 5000, 10000,  PAR_IS_UINT,   10,		 NULL, true, false, UNITS_VOLT},
	{"04 ÊÎİÔÔÈÖÈÅÍÒ Kp",		0x5D03,		0,  1000,  PAR_IS_UINT,   10,		 NULL, true, false, UNITS_VOID},
	{"05 ×ÀÑÒÎÒÀ ØÈÌ",			0x5D04,	 1000, 10000,  PAR_IS_UINT,    1,		 NULL, true, false, UNITS_HZ},
...
static const tParam group94_params[] = {
	{"01 ×ÀÑÒÎÒÀ ÀËÃÎĞÈÒÌÀ",	0x5E00,		0, 50000,  PAR_IS_UINT,    1,		 NULL, true, false, UNITS_HZ},
...
//--------------------------Ãğóïïà 96---------------------------------
// Ñïèñêè ïàğàìåòğîâ (îäíîé ñòğîêîé ñ \0 ğàçäåëèòåëÿìè)
static const char listG96P01[] =  "NEW MOTOR\0ÀÈĞ160S2(15k)\0ÀÈĞ132M2(11k)\0AÈĞ112M2(7k5)\0ÀÈĞ100L2(5k5)\0ÀÈĞ100S2(4k)\0ÀÈĞ90L2(3k)\0ÀÈĞ160M2(18k5)\0ÀÈĞ132S4(7k5)\0ÀÈĞ80B4(1k5)\0ÀÈĞ71Â4(750W)\0ÀÈĞ63A4(250W)";
static const char listG96P11[] =  "NOT IDENTIFIED\0IDENTIFIED\0LIBRARY";


// Ïàğàìåòğû ãğóïïû 96
static const tParam group96_params[] = {
	{"01 ÂÛÁÎĞ ÀÊÒ. ÄÂÈÃ", 	 	0x6000,		0,    10,  PAR_IS_LIST,    1,  listG96P01,  true, false, UNITS_VOID},
	{"02 ÍÎÌ. ÍÀÏĞßÆÅÍÈÅ",		0x6001,		0,  1000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_VOLT},
	{"03 ÍÎÌ. ×ÀÑÒÎÒÀ",			0x6002,		0,   100,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_HZ},
	{"04 ÍÎÌ. ÌÎÙÍÎÑÒÜ",		0x6003,		0,   600,  PAR_IS_UINT,   10,		 NULL,  true, false, UNITS_KWT},
	{"05 ÍÎÌ. ÑÊÎĞÎÑÒÜ",		0x6004,		0,  6000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_RPM},
	{"06 ÍÎÌ. ÒÎÊ",				0x6005,		0,   100,  PAR_IS_UINT,  100,		 NULL,  true, false, UNITS_AMP},
	{"07 ÑÎÏĞ. ÑÒÀÒÎĞÀ Rs",		0x6006,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
	{"08 ÈÍÄ. ÍÀÌÀÃÍ. M",		0x6007,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"09 ÈÍÄ. ĞÀÑÑÅßÍÈß Lg",	0x6008,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"10 ÑÎÏĞ. ĞÎÒÎĞÀ Rr",		0x6009,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
    {"11 ÑÒÀÒÓÑ ÄÂÈÃÀÒÅËß",		0x600A,		0,     2,  PAR_IS_LIST,    1,  listG96P11, false, false, UNITS_VOID},
...
// Ïàğàìåòğû ãğóïïû 97
static const tParam group97_params[] = {
	{"01 ÂÛÁÎĞ ÀÊÒ. ÄÂÈÃ", 	 	0x6100,		0,    10,  PAR_IS_LIST,    1,  listG96P01,  true, false, UNITS_VOID},
	{"02 ÍÎÌ. ÍÀÏĞßÆÅÍÈÅ",		0x6101,		0,  1000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_VOLT},
	{"03 ÍÎÌ. ×ÀÑÒÎÒÀ",			0x6102,		0,   100,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_HZ},
	{"04 ÍÎÌ. ÌÎÙÍÎÑÒÜ",		0x6103,		0,   600,  PAR_IS_UINT,   10,		 NULL,  true, false, UNITS_KWT},
	{"05 ÍÎÌ. ÑÊÎĞÎÑÒÜ",		0x6104,		0,  6000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_RPM},
	{"06 ÍÎÌ. ÒÎÊ",				0x6105,		0,   100,  PAR_IS_UINT,  100,		 NULL,  true, false, UNITS_AMP},
	{"07 ÑÎÏĞ. ÑÒÀÒÎĞÀ Rs",		0x6106,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
	{"08 ÈÍÄ. ÍÀÌÀÃÍ. M",		0x6107,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"09 ÈÍÄ. ĞÀÑÑÅßÍÈß Lg",	0x6108,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"10 ÑÎÏĞ. ĞÎÒÎĞÀ Rr",		0x6109,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
    {"11 ÑÒÀÒÓÑ ÄÂÈÃÀÒÅËß",		0x610A,		0,     2,  PAR_IS_LIST,    1,  listG96P11, false, false, UNITS_VOID},

};

// Ãğóïïà ïàğàìåòğîâ
const tGroup Group97 = {
	"97 ÏÀĞÀÌ. ÄÂÈÃ. #2",
    group97_params,
    sizeof(group97_params)/sizeof(tParam),
	true
};
//--------------------------------------------------------------------
...
// Ïàğàìåòğû ãğóïïû 98
static const tParam group98_params[] = {
	{"01 ÂÛÁÎĞ ÀÊÒ. ÄÂÈÃ", 	 	0x6200,		0,    10,  PAR_IS_LIST,    1,  listG96P01,  true, false, UNITS_VOID},
	{"02 ÍÎÌ. ÍÀÏĞßÆÅÍÈÅ",		0x6201,		0,  1000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_VOLT},
	{"03 ÍÎÌ. ×ÀÑÒÎÒÀ",			0x6202,		0,   100,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_HZ},
	{"04 ÍÎÌ. ÌÎÙÍÎÑÒÜ",		0x6203,		0,   600,  PAR_IS_UINT,   10,		 NULL,  true, false, UNITS_KWT},
	{"05 ÍÎÌ. ÑÊÎĞÎÑÒÜ",		0x6204,		0,  6000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_RPM},
	{"06 ÍÎÌ. ÒÎÊ",				0x6205,		0,   100,  PAR_IS_UINT,  100,		 NULL,  true, false, UNITS_AMP},
	{"07 ÑÎÏĞ. ÑÒÀÒÎĞÀ Rs",		0x6206,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
	{"08 ÈÍÄ. ÍÀÌÀÃÍ. M",		0x6207,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"09 ÈÍÄ. ĞÀÑÑÅßÍÈß Lg",	0x6208,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"10 ÑÎÏĞ. ĞÎÒÎĞÀ Rr",		0x6209,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
    {"11 ÑÒÀÒÓÑ ÄÂÈÃÀÒÅËß",		0x620A,		0,     2,  PAR_IS_LIST,    1,  listG96P11, false, false, UNITS_VOID},

};

// Ãğóïïà ïàğàìåòğîâ
const tGroup Group98 = {
	"98 ÏÀĞÀÌ. ÄÂÈÃ. #3",
    group98_params,
    sizeof(group98_params)/sizeof(tParam),
	true
};
//--------------------------------------------------------------------
...
// Ïàğàìåòğû ãğóïïû 99
static const tParam group99_params[] = {
	{"01 ÂÛÁÎĞ ÀÊÒ. ÄÂÈÃ", 	 	0x6300,		0,    10,  PAR_IS_LIST,    1,  listG96P01,  true, false, UNITS_VOID},
	{"02 ÍÎÌ. ÍÀÏĞßÆÅÍÈÅ",		0x6301,		0,  1000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_VOLT},
	{"03 ÍÎÌ. ×ÀÑÒÎÒÀ",			0x6302,		0,   100,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_HZ},
	{"04 ÍÎÌ. ÌÎÙÍÎÑÒÜ",		0x6303,		0,   600,  PAR_IS_UINT,   10,		 NULL,  true, false, UNITS_KWT},
	{"05 ÍÎÌ. ÑÊÎĞÎÑÒÜ",		0x6304,		0,  6000,  PAR_IS_UINT,    1,		 NULL,  true, false, UNITS_RPM},
	{"06 ÍÎÌ. ÒÎÊ",				0x6305,		0,   100,  PAR_IS_UINT,  100,		 NULL,  true, false, UNITS_AMP},
	{"07 ÑÎÏĞ. ÑÒÀÒÎĞÀ Rs",		0x6306,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
	{"08 ÈÍÄ. ÍÀÌÀÃÍ. M",		0x6307,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"09 ÈÍÄ. ĞÀÑÑÅßÍÈß Lg",	0x6308,		0, 10000,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_HENRI},
	{"10 ÑÎÏĞ. ĞÎÒÎĞÀ Rr",		0x6309,		0, 65535,  PAR_IS_UINT, 1000,		 NULL, false, false, UNITS_OHM},
    {"11 ÑÒÀÒÓÑ ÄÂÈÃÀÒÅËß",		0x630A,		0,     2,  PAR_IS_LIST,    1,  listG96P11, false, false, UNITS_VOID},

};

// Ãğóïïà ïàğàìåòğîâ
const tGroup Group99 = {
	"99 ÏÀĞÀÌ. ÄÂÈÃ. #4",
    group99_params,
    sizeof(group99_params)/sizeof(tParam),
	true
};
//--------------------------------------------------------------------
