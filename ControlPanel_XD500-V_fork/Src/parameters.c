...
static const tParam group12_params[] = {
	...
	{"02 ÏÎÑÒ ÑÊÎĞ 1", 	    0x0C01, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"03 ÏÎÑÒ ÑÊÎĞ 2", 	    0x0C02, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"04 ÏÎÑÒ ÑÊÎĞ 3", 	    0x0C03, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"05 ÏÎÑÒ ÑÊÎĞ 4", 	    0x0C04, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"06 ÏÎÑÒ ÑÊÎĞ 5", 	    0x0C05, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"07 ÏÎÑÒ ÑÊÎĞ 6", 	    0x0C06, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"08 ÏÎÑÒ ÑÊÎĞ 7", 	    0x0C07, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
	{"09 ÏÎÑÒ ÑÊÎĞ 8", 	    0x0C08, (uint16_t)(-6000), 6000,  PAR_IS_INT,  10, NULL,       true, false, UNITS_RPM},
...
static const tParam group68_params[] = {
	{"ÏÎ XD500-V",        0x4400, 			       0, 65535,  PAR_IS_UINT,  1, NULL, false, false, UNITS_VOID},
	{"×ÀÑÒÎÒÀ", 	      0x4401,  (uint16_t)(-1000),  1000,  PAR_IS_INT,  10, NULL, false, false, UNITS_HZ},
	{"ÑÊÎĞÎÑÒÜ", 	      0x4402, (uint16_t)(-20000), 20000,  PAR_IS_INT,   1, NULL, false, false, UNITS_RPM},
	{"ÒÎÊ ÄÂÈÃ", 	      0x4403,                  0, 10000,  PAR_IS_INT,  10, NULL, false, false, UNITS_AMP},
	{"ÌÎÌÅÍÒ", 	      	  0x4404,  (uint16_t)(-2000),  2000,  PAR_IS_INT,  10, NULL, false, false, UNITS_VOID},
	{"ÌÎÙÍÎÑÒÜ", 		  0x4405, 		 	       0, 10000,  PAR_IS_INT, 100, NULL, false, false, UNITS_KWT},
	{"ÍÀÏĞßÆ ÄÂÈÃ",  	  0x4406,                  0, 10000,  PAR_IS_INT,  10, NULL, false, false, UNITS_VOLT},
	{"ÍÀÏĞßÆ DC",    	  0x4407,                  0, 10000,  PAR_IS_INT,  10, NULL, false, false, UNITS_VOLT},
	{"ÒÅÌÏ IGBT",    	  0x4408,                  0, 10000,  PAR_IS_INT,  10, NULL, false, false, UNITS_VOLT}
