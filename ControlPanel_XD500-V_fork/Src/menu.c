...
void InitBasicMenu(void)
{
	...
	Menu_AddItem("АРХИВ СОБЫТИЙ", -1, 2, NoScr, NULL); //[1]
	Menu_AddItem("БЫСТРЫЙ СТАРТ", -1, 3, NoScr, NULL); //[2]
	Menu_AddItem("ФУНКЦИИ КОПИРОВАНИЯ", -1, 4, NoScr, NULL); //[3]
	Menu_AddItem("ВЕРСИИ ПО", -1, 5, SoftVersionsScr, NULL); //[4]
