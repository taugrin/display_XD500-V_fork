...
void ST7565_drawstring(uint8_t x, uint8_t line, const char *c)
{
  while (c[0] != 0)
  {
    ...
    if (line >= (LCDHEIGHT/8)) {return;}        // ran out of space :(
...
void  ST7565_drawchar(uint8_t x, uint8_t line, char c) {
  ...
  for (i = 0; i < 5; i++, x++) st7565_buffer[x + (line * 128) ] = font[((unsigned char)c * 5) + i];
...
void ST7565_inv_fillrect(uint8_t x, uint8_t y, uint8_t w, uint8_t h, uint8_t color) {
  ...
  for (i=x; i<x+w; i++) {
    for (j=y; j<y+h; j++) {
        ...
        buffer = ST7565_getpixel(i, j);

        ST7565_my_setpixel(i, j, !buffer);
    }
  }
...
uint8_t StartImage[1024] = {
		,
...
{
  memcpy(st7565_buffer, StartImage, 1024);
  //ST7565_updateBoundingBox(0, 0, LCDWIDTH-1, LCDHEIGHT-1);
}
